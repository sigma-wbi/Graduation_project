...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMake 3.21 Release Notes &mdash; CMake 3.21.4 Documentation</title>
  ...
  <div class="section" id="cmake-3-21-release-notes">
<h1><a class="toc-backref" href="#id5">CMake 3.21 Release Notes</a><a class="headerlink" href="#cmake-3-21-release-notes" title="Permalink to this headline">¶</a></h1>
<div class="contents topic" id="contents">
<p class="topic-title">Contents</p>
<ul class="simple">
<li><p><a class="reference internal" href="#cmake-3-21-release-notes" id="id5">CMake 3.21 Release Notes</a></p>
<ul>
...
<li><p><a class="reference internal" href="#compilers" id="id11">Compilers</a></p></li>
<li><p><a class="reference internal" href="#platforms" id="id12">Platforms</a></p></li>
<li><p><a class="reference internal" href="#file-based-api" id="id13">File-Based API</a></p></li>
...
<li><p><a class="reference internal" href="#properties" id="id16">Properties</a></p></li>
<li><p><a class="reference internal" href="#modules" id="id17">Modules</a></p></li>
<li><p><a class="reference internal" href="#generator-expressions" id="id18">Generator Expressions</a></p></li>
...
<ul>
<li><p><a class="reference internal" href="#id1" id="id24">3.21.1</a></p></li>
<li><p><a class="reference internal" href="#id2" id="id25">3.21.2</a></p></li>
<li><p><a class="reference internal" href="#id3" id="id26">3.21.3</a></p></li>
<li><p><a class="reference internal" href="#id4" id="id27">3.21.4</a></p></li>
</ul>
</li>
</ul>
</li>
...
<h3><a class="toc-backref" href="#id7">Presets</a><a class="headerlink" href="#presets" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<ul class="simple">
<li><p>The <span class="target" id="index-0-generator:Visual Studio 17 2022"></span><a class="reference internal" href="../generator/Visual Studio 17 2022.html#generator:Visual Studio 17 2022" title="Visual Studio 17 2022"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Visual</span> <span class="pre">Studio</span> <span class="pre">17</span> <span class="pre">2022</span></code></a> generator was added.</p></li>
...
<h3><a class="toc-backref" href="#id9">Languages</a><a class="headerlink" href="#languages" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<ul class="simple">
<li><p><span class="target" id="index-0-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> gained the <code class="docutils literal notranslate"><span class="pre">--install-prefix</span> <span class="pre">&lt;dir&gt;</span></code>
command-line option to specify the location of the install prefix.</p></li>
<li><p><span class="target" id="index-1-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> gained the <code class="docutils literal notranslate"><span class="pre">--toolchain</span> <span class="pre">&lt;path/to/file&gt;</span></code>
command-line option to specify a toolchain file.</p></li>
<li><p><span class="target" id="index-2-manual:cmake(1)"></span><a class="reference internal" href="../manual/cmake.1.html#manual:cmake(1)" title="cmake(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">cmake(1)</span></code></a> <code class="docutils literal notranslate"><span class="pre">-E</span> <span class="pre">capabilities</span></code> output, for some generators,
may now contain a <code class="docutils literal notranslate"><span class="pre">supportedPlatforms</span></code> field listing platforms
known to be supported in <span class="target" id="index-0-variable:CMAKE_GENERATOR_PLATFORM"></span><a class="reference internal" href="../variable/CMAKE_GENERATOR_PLATFORM.html#variable:CMAKE_GENERATOR_PLATFORM" title="CMAKE_GENERATOR_PLATFORM"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_GENERATOR_PLATFORM</span></code></a>.</p></li>
<li><p>Messages printed to a terminal now may be colored by message type.</p></li>
</ul>
</div>
<div class="section" id="compilers">
<h3><a class="toc-backref" href="#id11">Compilers</a><a class="headerlink" href="#compilers" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id12">Platforms</a><a class="headerlink" href="#platforms" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li><p>CMake now supports the MSYS runtime environment, much like CYGWIN.</p></li>
</ul>
</div>
<div class="section" id="file-based-api">
<h3><a class="toc-backref" href="#id13">File-Based API</a><a class="headerlink" href="#file-based-api" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id14">Commands</a><a class="headerlink" href="#commands" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<li><p>The <span class="target" id="index-0-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(COPY_FILE)</span></code></a> command was added to copy a single file.</p></li>
<li><p>The <span class="target" id="index-1-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(GET_RUNTIME_DEPENDENCIES)</span></code></a> command gained new
...
<li><p>The <span class="target" id="index-3-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(RENAME)</span></code></a> command learned to optionally capture
...
<span class="target" id="index-4-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(GET_RUNTIME_DEPENDENCIES)</span></code></a>.</p></li>
...
runtime dependencies using <span class="target" id="index-5-command:file"></span><a class="reference internal" href="../command/file.html#command:file" title="file"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">file(GET_RUNTIME_DEPENDENCIES)</span></code></a>.</p></li>
<li><p>The <span class="target" id="index-4-command:install"></span><a class="reference internal" href="../command/install.html#command:install" title="install"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">install(SCRIPT|CODE)</span></code></a> command
...
<h3><a class="toc-backref" href="#id15">Variables</a><a class="headerlink" href="#variables" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id16">Properties</a><a class="headerlink" href="#properties" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id17">Modules</a><a class="headerlink" href="#modules" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id18">Generator Expressions</a><a class="headerlink" href="#generator-expressions" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id19">CTest</a><a class="headerlink" href="#ctest" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<li><p><span class="target" id="index-2-manual:ctest(1)"></span><a class="reference internal" href="../manual/ctest.1.html#manual:ctest(1)" title="ctest(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ctest(1)</span></code></a> gained a <code class="docutils literal notranslate"><span class="pre">--output-junit</span></code> option to write test results
to a JUnit XML file.</p></li>
...
<h3><a class="toc-backref" href="#id20">CPack</a><a class="headerlink" href="#cpack" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h2><a class="toc-backref" href="#id21">Deprecated and Removed Features</a><a class="headerlink" href="#deprecated-and-removed-features" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
...
<h2><a class="toc-backref" href="#id22">Other Changes</a><a class="headerlink" href="#other-changes" title="Permalink to this headline">¶</a></h2>
<ul class="simple">
...
<li><p>The <span class="target" id="index-0-command:set"></span><a class="reference internal" href="../command/set.html#command:set" title="set"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">set(CACHE)</span></code></a> command no longer removes a normal variable
...
<li><p>The <span class="target" id="index-0-generator:NMake Makefiles"></span><a class="reference internal" href="../generator/NMake Makefiles.html#generator:NMake Makefiles" title="NMake Makefiles"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">NMake</span> <span class="pre">Makefiles</span></code></a> generator now encodes the generated
...
<h2><a class="toc-backref" href="#id23">Updates</a><a class="headerlink" href="#updates" title="Permalink to this headline">¶</a></h2>
<p>Changes made since CMake 3.21.0 include the following.</p>
<div class="section" id="id1">
<h3><a class="toc-backref" href="#id24">3.21.1</a><a class="headerlink" href="#id1" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li><p>The <span class="target" id="index-1-generator:Visual Studio 17 2022"></span><a class="reference internal" href="../generator/Visual Studio 17 2022.html#generator:Visual Studio 17 2022" title="Visual Studio 17 2022"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Visual</span> <span class="pre">Studio</span> <span class="pre">17</span> <span class="pre">2022</span></code></a> generator is now based on
&quot;Visual Studio 2022 Preview 2&quot;.  Previously it was based on &quot;Preview 1.1&quot;.</p></li>
</ul>
</div>
<div class="section" id="id2">
<h3><a class="toc-backref" href="#id25">3.21.2</a><a class="headerlink" href="#id2" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<li><p>The <span class="target" id="index-2-generator:Visual Studio 17 2022"></span><a class="reference internal" href="../generator/Visual Studio 17 2022.html#generator:Visual Studio 17 2022" title="Visual Studio 17 2022"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Visual</span> <span class="pre">Studio</span> <span class="pre">17</span> <span class="pre">2022</span></code></a> generator is now based on
&quot;Visual Studio 2022 Preview 3.1&quot;.  Previously it was based on &quot;Preview 2&quot;.</p></li>
</ul>
</div>
<div class="section" id="id3">
<h3><a class="toc-backref" href="#id26">3.21.3</a><a class="headerlink" href="#id3" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li><p>The <span class="target" id="index-3-generator:Visual Studio 17 2022"></span><a class="reference internal" href="../generator/Visual Studio 17 2022.html#generator:Visual Studio 17 2022" title="Visual Studio 17 2022"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Visual</span> <span class="pre">Studio</span> <span class="pre">17</span> <span class="pre">2022</span></code></a> generator is now based on
&quot;Visual Studio 2022 Preview 4&quot;.  Previously it was based on &quot;Preview 3.1&quot;.</p></li>
<li><p>The AMD ROCm Platform <code class="docutils literal notranslate"><span class="pre">hipcc</span></code> compiler was identifed by CMake 3.21.0
...
<h3><a class="toc-backref" href="#id27">3.21.4</a><a class="headerlink" href="#id4" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li><p>The <span class="target" id="index-4-generator:Visual Studio 17 2022"></span><a class="reference internal" href="../generator/Visual Studio 17 2022.html#generator:Visual Studio 17 2022" title="Visual Studio 17 2022"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Visual</span> <span class="pre">Studio</span> <span class="pre">17</span> <span class="pre">2022</span></code></a> generator is now based on the

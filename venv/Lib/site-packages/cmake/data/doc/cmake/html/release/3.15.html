...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMake 3.15 Release Notes &mdash; CMake 3.21.4 Documentation</title>
  ...
  <div class="section" id="cmake-3-15-release-notes">
<h1><a class="toc-backref" href="#id5">CMake 3.15 Release Notes</a><a class="headerlink" href="#cmake-3-15-release-notes" title="Permalink to this headline">¶</a></h1>
...
<h3><a class="toc-backref" href="#id8">Languages</a><a class="headerlink" href="#languages" title="Permalink to this headline">¶</a></h3>
<ul>
...
<h3><a class="toc-backref" href="#id9">Compilers</a><a class="headerlink" href="#compilers" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id15">Generator Expressions</a><a class="headerlink" href="#generator-expressions" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<code class="docutils literal notranslate"><span class="pre">C_COMPILER_ID</span></code>, <code class="docutils literal notranslate"><span class="pre">CXX_COMPILER_ID</span></code>, <code class="docutils literal notranslate"><span class="pre">CUDA_COMPILER_ID</span></code>,
<code class="docutils literal notranslate"><span class="pre">Fortran_COMPILER_ID</span></code>, <code class="docutils literal notranslate"><span class="pre">COMPILE_LANGUAGE</span></code>, <code class="docutils literal notranslate"><span class="pre">COMPILE_LANG_AND_ID</span></code>, and
<code class="docutils literal notranslate"><span class="pre">PLATFORM_ID</span></code> learned to support matching one value from a comma-separated
list.</p></li>
<li><p>The <code class="docutils literal notranslate"><span class="pre">$&lt;CUDA_COMPILER_ID:...&gt;</span></code> and <code class="docutils literal notranslate"><span class="pre">$&lt;CUDA_COMPILER_VERSION:...&gt;</span></code>
...
<li><p>The <code class="docutils literal notranslate"><span class="pre">$&lt;COMPILE_LANG_AND_ID:...&gt;</span></code> generator expression was introduced to
...
<li><p>A <code class="docutils literal notranslate"><span class="pre">$&lt;FILTER:list,INCLUDE|EXCLUDE,regex&gt;</span></code>
...
has been added.</p></li>
<li><p>A <code class="docutils literal notranslate"><span class="pre">$&lt;REMOVE_DUPLICATES:list&gt;</span></code>
<span class="target" id="index-3-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expression</span></code></a>
has been added.</p></li>
<li><p>The <code class="docutils literal notranslate"><span class="pre">$&lt;SHELL_PATH:...&gt;</span></code> <span class="target" id="index-4-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expression</span></code></a> gained support for a list of paths.</p></li>
<li><p>New <code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE*&gt;</span></code> <span class="target" id="index-5-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expressions</span></code></a> were added to retrieve the prefix, base
name, and suffix of the file names of various artifacts:</p>
<ul>
<li><p><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE_PREFIX:...&gt;</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE_BASE_NAME:...&gt;</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_FILE_SUFFIX:...&gt;</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_LINKER_FILE_PREFIX:...&gt;</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_LINKER_FILE_BASE_NAME:...&gt;</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_LINKER_FILE_SUFFIX:...&gt;</span></code></p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_PDB_FILE_BASE_NAME:...&gt;</span></code></p></li>
</ul>
</li>
<li><p>The <code class="docutils literal notranslate"><span class="pre">$&lt;TARGET_OBJECTS:...&gt;</span></code> <span class="target" id="index-6-manual:cmake-generator-expressions(7)"></span><a class="reference internal" href="../manual/cmake-generator-expressions.7.html#manual:cmake-generator-expressions(7)" title="cmake-generator-expressions(7)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">generator</span> <span class="pre">expression</span></code></a> is now supported on <code class="docutils literal notranslate"><span class="pre">SHARED</span></code>,
<code class="docutils literal notranslate"><span class="pre">STATIC</span></code>, <code class="docutils literal notranslate"><span class="pre">MODULE</span></code> libraries and executables.</p></li>
</ul>
</div>
...
<h3><a class="toc-backref" href="#id21">3.15.1</a><a class="headerlink" href="#id1" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id22">3.15.2</a><a class="headerlink" href="#id2" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id23">3.15.3</a><a class="headerlink" href="#id3" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id24">3.15.4</a><a class="headerlink" href="#id4" title="Permalink to this headline">¶</a></h3>
<ul class="simple">

...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMake 3.20 Release Notes &mdash; CMake 3.21.4 Documentation</title>
  ...
  <div class="section" id="cmake-3-20-release-notes">
<h1><a class="toc-backref" href="#id5">CMake 3.20 Release Notes</a><a class="headerlink" href="#cmake-3-20-release-notes" title="Permalink to this headline">¶</a></h1>
...
<h3><a class="toc-backref" href="#id10">Compilers</a><a class="headerlink" href="#compilers" title="Permalink to this headline">¶</a></h3>
<ul>
...
<h3><a class="toc-backref" href="#id12">File-Based API</a><a class="headerlink" href="#file-based-api" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
support for new generator expressions <code class="docutils literal notranslate"><span class="pre">$&lt;COMMAND_CONFIG:...&gt;</span></code> and
<code class="docutils literal notranslate"><span class="pre">$&lt;OUTPUT_CONFIG:...&gt;</span></code> that control cross-config handling when using
the <span class="target" id="index-0-generator:Ninja Multi-Config"></span><a class="reference internal" href="../generator/Ninja Multi-Config.html#generator:Ninja Multi-Config" title="Ninja Multi-Config"><code class="xref cmake cmake-generator docutils literal notranslate"><span class="pre">Ninja</span> <span class="pre">Multi-Config</span></code></a> generator.</p>
</li>
...
<li><p>The <span class="target" id="index-0-prop_sf:GENERATED"></span><a class="reference internal" href="../prop_sf/GENERATED.html#prop_sf:GENERATED" title="GENERATED"><code class="xref cmake cmake-prop_sf docutils literal notranslate"><span class="pre">GENERATED</span></code></a> source-file property is now visible
...
<h3><a class="toc-backref" href="#id17">Autogen</a><a class="headerlink" href="#autogen" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id18">CTest</a><a class="headerlink" href="#ctest" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
<li><p><span class="target" id="index-0-manual:ctest(1)"></span><a class="reference internal" href="../manual/ctest.1.html#manual:ctest(1)" title="ctest(1)"><code class="xref cmake cmake-manual docutils literal notranslate"><span class="pre">ctest(1)</span></code></a> gained a <code class="docutils literal notranslate"><span class="pre">--test-dir</span></code> option to specify the directory
in which to look for tests.</p></li>
</ul>
</div>
<div class="section" id="cpack">
<h3><a class="toc-backref" href="#id19">CPack</a><a class="headerlink" href="#cpack" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<a class="reference external" href="https://spdx.org/">Software Package Data Exchange</a> (SPDX).</p></li>
...
<h3><a class="toc-backref" href="#id23">3.20.1</a><a class="headerlink" href="#id2" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id24">3.20.2</a><a class="headerlink" href="#id3" title="Permalink to this headline">¶</a></h3>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id25">3.20.3, 3.20.4, 3.20.5, 3.20.6</a><a class="headerlink" href="#id4" title="Permalink to this headline">¶</a></h3>
